...
class App {
    ...
    static public function init() {
        ...
        if(C('REQUEST_VARS_FILTER')){
			// 全局安全过滤
			array_walk_recursive($_GET,		'any_filter');
			array_walk_recursive($_POST,	'any_filter');
			array_walk_recursive($_REQUEST,	'any_filter');
		}
        ...
        try{
            ...
            if($method->isPublic() && !$method->isStatic()) {
                ...
                if($method->getNumberOfParameters()>0 && C('URL_PARAMS_BIND')){
					...
					array_walk_recursive($args,'any_filter');
