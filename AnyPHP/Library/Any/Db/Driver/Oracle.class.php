...
class Oracle extends Driver{
    ...
    private     $table        = '';
    protected   $selectSql    = 'SELECT * FROM (SELECT anyphp.*, rownum AS numrow FROM (SELECT  %DISTINCT% %FIELD% FROM %TABLE%%JOIN%%WHERE%%GROUP%%HAVING%%ORDER%) anyphp ) %LIMIT%%COMMENT%';
