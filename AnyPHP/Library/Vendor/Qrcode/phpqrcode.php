 ...
 */
    ...
    class QRimage {
        ...
        public static function png($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE) 
        {
            ...
            if ($saveandprint==='GDRESOURCE') return $image;
    ...
    class QRencode {
        ...
        public function encodePNG($intext, $outfile = false,$saveandprint=false) 
        {
            try {
                ...
                $image_rs = QRimage::png($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint);
                if ($image_rs) return $image_rs;
            } catch (Exception $e) {
